...
for template_count = 1:length(template_list)
    ...
    for station_count = 1:length(station_list)
        ...
        folder_check = sprintf('./%s/%s/arrivals/%s',single_station.network,single_station.station,single_station.template);
        ...
        arrival_times = produceArrivalTimes(NET,single_station.channel_list{1},single_station.channel_list{2},single_station.channel_list{3},STA,first_date,last_date,single_station.pWaveArrival,single_station.sWaveArrival,window,single_station.template);
